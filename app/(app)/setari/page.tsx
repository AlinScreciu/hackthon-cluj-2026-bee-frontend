    ...
    <div className="px-4 md:px-6 lg:px-8 py-4 lg:max-w-2xl">
      <div className="space-y-4 lg:space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 h-12 bg-white text-alert border border-alert/30 font-semibold rounded-xl shadow-sm disabled:opacity-50 transition-opacity lg:max-w-xs"
        >
          {loggingOut ? (
